...
export default function AboutUsContent() {
  return (
    <div className={styles.aboutUsContent}>
      ...
      >
        <img src="/SaoPauloRosa.png" className={styles.saoPauloImage} />
          ...
          <div className={styles.halfWidth}>
            <div className={styles.imageTextText}>
              ...
              <p>
                ...
                1400 jovens universitários. “Jeito NSP de agir”
              </p>
            </div>
          </div>
          <div className={styles.halfWidth}>
      ...
      <div className={styles.allWidth}>
        <img src="/Black Dots.png" className={styles.dotsMission} />
        <div className={styles.aboutUsTexts}>
          <div className={styles.subtitle}>
        ...
        <div className={styles.allWidth} style={{ marginBottom: "2rem" }}>
          <div className={styles.aboutUsTexts80}>
            ...
            <p>
              ...
              protagonista que transforma o potencial da região em resultadp
            </p>
          </div>
        </div>
      </div>
          ...
          <div className={styles.halfWidth}>
            ...
            >
              ...
              <div className={styles.horizontalContainer}>
                ...
                <div className={styles.verticalContainer}>
                  <AccessibilityIcon />
                  <p>protagonismo e resiliência</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <div className={styles.valuesContent}>
        <div className={styles.allWidth}>
          ...
          <div className={styles.cardsDisplay}>
            <div>
              <ExpansiveCard
                avatarImage="/avatars/woman-puts-hand-in-pocket.jpg"
                Department="Expansão"
                Director=""
                ...
                biggerImage="/avatars/a-pair-of-hands-typing-away-close-up.jpg"
              ></ExpansiveCard>
            </div>
            <div>
              <ExpansiveCard
