    ...
    <div className={styles.servicesContent}>
      ...
      <div className={styles.allWidth}>
        <div className={styles.servicesTexts}>
          ...
          <p>
            As empresas juniores são capazes de oferecer um{" "}
            <span className={styles.coloredTitle}>
            ...
            serviços ao seu cliente. Este atendimento mais próximo é possível 
            graças à estrutura e aos objetivos particulares de uma empresa júnior.
          </p>
          <p>
